      ...
      <main class="main-content">
        ...
        <header class="page-hero">
          <div class="hero-text">
            ...
            <p class="hero-subtitle">
              Launch data privacy, impact assessment, and system governance workflows for your
        ...
        <section class="modules-grid-section">
          <div class="modules-grid">
            ...
            <div class="module-card dpia-card" @click="handleDpiaClick">
              ...
              <div class="card-inner">
                ...
                <div class="card-body-content">
                  ...
                  <p class="module-desc">
                    Data Protection Impact Assessment module for evaluating data privacy risks,
                    compliance obligations, and risk mitigation measures.
                  </p>
                </div>
            ...
            <div
              v-if="authStore.primaryRole === 'System Administrator'"
            ...
            >
              ...
              <div class="card-inner">
                ...
                <div class="card-body-content">
                  ...
                  <p class="module-desc">
                    Manage enterprise user accounts, RBAC permissions, security audit trails, and
                    global GRC settings.
                  </p>
                </div>
            ...
            <!-- VAPT Assessment Coming Soon Card -->
