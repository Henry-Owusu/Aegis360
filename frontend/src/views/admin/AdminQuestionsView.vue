...
const questions = ref([
  {
    id: 'q1',
    text: 'Does this project involve the processing of sensitive personal data?',
    module: 'DPIA',
    type: 'Yes/No',
    required: true,
    status: 'active',
  ...
  {
    id: 'q2',
    text: 'Are you transferring data outside the EU/EEA?',
    module: 'DPIA',
    type: 'Yes/No',
    required: true,
    status: 'active',
  ...
  {
    id: 'q3',
    text: 'Describe the nature of the data being processed.',
    module: 'DPIA',
    type: 'Long Text',
    required: true,
    status: 'active',
  ...
  {
    id: 'q4',
    text: 'What is the lawful basis for processing?',
    module: 'DPIA',
    type: 'Single Select',
    required: true,
    status: 'draft',
  ...
  {
    id: 'q5',
    text: 'Identify third-party processors involved.',
    module: 'Vendor Risk',
    type: 'Multi Select',
    required: false,
    status: 'active',
