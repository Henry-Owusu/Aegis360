...
const articles = ref([
  {
    ...
    category: 'users',
    excerpt: 'Learn how to define custom roles and assign specific permissions to them.',
  },
  {
    id: 2,
    title: 'Configuring DPIA automation triggers',
    category: 'assessments',
    excerpt:
      'Set up automatic triggers for Data Protection Impact Assessments based on project scope.',
  },
  {
    id: 3,
    title: 'Setting up Two-Factor Authentication (2FA)',
    category: 'security',
    excerpt: 'A step-by-step guide to enabling mandatory 2FA for all administrative accounts.',
  },
  {
    id: 4,
    title: 'Introduction to Aegis360 Admin Suite',
    category: 'getting-started',
    excerpt: 'Welcome to your compliance command center. Learn how to navigate the main dashboard.',
  },
])
</script>
  ...
  <AdminLayout>
    <div class="help-center-hero">
      ...
      <div class="search-box">
        ...
        <input
          v-model="searchQuery"
          type="text"
          placeholder="Search knowledge base articles, FAQs, and guides..."
        />
      </div>
    </div>
    ...
    <div class="help-content">
      ...
      <div class="articles-grid">
        <div
          v-for="art in articles.filter((a) => a.category === activeCategory)"
          :key="art.id"
          class="article-card"
        >
          <h4>{{ art.title }}</h4>
        ...
        <div
          v-if="articles.filter((a) => a.category === activeCategory).length === 0"
          class="empty-state"
        >
...
.cat-btn.active {
  ...
  color: #f58425;
  border-color: rgba(245, 132, 37, 0.2);
}
.cat-btn svg {
  width: 18px;
  height: 18px;
